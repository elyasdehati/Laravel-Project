...
class HomeController extends Controller
{
    ...
    public function UpdateUsability(Request $request){
        ...
        $usa_id = $request->id;
        $usability = Usability::find($usa_id);
    ...
    public function EditConnect($id){
        $conn_id = Connect::find($id);
        return view('admin.backend.connect.edit_connect', compact('conn_id'));
    }
    // End Method
    ...
    public function UpdateAppsImage(Request $request, $id){
        ...
        if ($request->file('image')) {
            ...
            if (file_exists(public_path($apps->imge))) {
