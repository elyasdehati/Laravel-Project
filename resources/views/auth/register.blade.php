    ...
    <form method="POST" action="{{ route('register') }}" class="my-4">
        @csrf
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="name" id="name" name="name" required="" placeholder="Enter your email">
                                            </div>
        ...
        <div class="text-center text-muted mb-4">
            <p class="mb-0">Want to Login<a class='text-primary ms-2fw-medium' href='{{ route('login') }}'>Login</a></p>
        </div>
