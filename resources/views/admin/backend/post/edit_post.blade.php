    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-6 col-xl-6">
                <select name="blogcat_id" id="example-select" class="form-select">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-12 col-xl-12">
                <img id="showImage" src="{{ url( $post->image ) }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
            </div>
        </div>
