...
<form action="{{route('update.clarifies')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-12 col-xl-12">
                <textarea class="form-control" name="description">{{$clarifies->description}}</textarea>
            </div>
        </div>
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-12 col-xl-12">
                <img id="showImage" src="{{ asset($clarifies->image) }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
            </div>
        </div>
