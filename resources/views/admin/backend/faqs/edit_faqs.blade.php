...
<form action="{{route('update.faqs')}}" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="id" value="{{$faqsId->id}}">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-12 col-xl-12">
                <input class="form-control" type="text" name="title" value="{{$faqsId->title}}">
            </div>
        </div>
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-12 col-xl-12">
                <textarea class="form-control" name="description">{{$faqsId->description}}</textarea>
            </div>
        </div>
